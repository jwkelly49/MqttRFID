 ...
 * @author jwkel
 */
public class ListAllGuestsController implements Initializable {
...
@FXML
    ...
    ObservableList<ListAllGuestsController.Locals> list = FXCollections.observableArrayList();
        ...
        if (rs != null) {
            try {
                while (rs.next()){
                    ...
                    list.add(new ListAllGuestsController.Locals(roadName1, roadNumber1, type1, color1, owner1) );
                }
            } catch (SQLException ex) {
                Logger.getLogger(ListAllGuestsController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
