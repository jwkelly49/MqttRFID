...
/**
 ...
 before they are imported into MqttRFID stock table
 */
...
//            System.out.println(e);
    ...
    to process the new tag into MqttRFID stock database. CarsController sets 
    ...
    */
    ...
    private void openCarsController() throws InterruptedException {
        ...
        try {
            ...
            // set true for car -- false for engine
            carsControl.loadTextFieldData(true, color, name, number, type);
            carsControl.JMRIcarsControl = carsControl;
...
//                System.out.println("got a good return");
                ...
                commonVars.setSavingJMRI(false);
            }else{
